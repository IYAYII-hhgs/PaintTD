...
public class GameHud {
    ...
    private Table build() {
        ...
        TextButton buttonTestClearSteps = ActorUtils.wrap(new TextButton("清除放置附加步骤", screen.app.skins.skin))
                                                ...
                                                .free();
        TextButton buttonTestUnit200 = ActorUtils.wrap(new TextButton("随机放置200个", screen.app.skins.skin))
                                            .click(b -> {
        ...
        TextButton buttonTestUnit5000 = ActorUtils.wrap(new TextButton("随机放置5000个", screen.app.skins.skin))
                                            .click(b -> {
                                                if (screen.placement.select == null) return;
        ...
        buttonsTable.add(buttonTestUnit200).row();
