...
/**
 * 处理{@link DamageQueue.SlashTileStainData}请求, 转换为{@link DamageQueue.DirectTileStainData}
 */
@IsLogicProcess
public class DamageApplySlashTileStain extends BaseSystem{
    ...
    protected void processSystem(){
        ...
        for(int i = 0; i < damageQueue.queue.size; i++){
            ...
            if(req.data instanceof DamageQueue.SlashTileStainData data){
                tmp.clear();
